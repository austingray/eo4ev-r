...
exports.seed = function(knex, Promise) {
  return Promise.join(
    ...
    //     id: 1,
    //     user_id: 1,
    //     post_title: "Character creation section almost done",
    //     post_content: "Currently creating the character creation page. You will be able to select your race and class, as well as preview your character in real time. Almost done, and everything is leading up to the new map system. That's the big one. Stay tuned!",
    //     created_at: "2016-06-12 04:05:11.120741+00"
    // })
