...
exports.seed = function(knex) {
  return Promise.all([
    ...
    //sexes
    knex('character_sexes').del(),
    knex('character_sexes').insert({id: 1, name: 'Male'}),
    knex('character_sexes').insert({id: 2, name: 'Female'}),

    // //races
    knex('character_races').del(),
    knex('character_races').insert({
        id: 1,
        name: 'Human',
        hue: 0.13,
        sat_min: 0.25,
    ...
    // //classes
    knex('character_classes').del(),
    knex('character_classes').insert({
        id: 1,
        name: 'Warrior',
